...
int numButtons = 9;
const uint8_t buttonPins[9] = {22, 21, 19, 18, 17, 16, 5, 4, 2};     // Fill in { } with list of GPIO pins
Bounce * buttons = new Bounce[9];         // Creates an array of Bounce objects

/* Bluetooth */
#include <BleKeyboard.h>                         // BleKeyboard Library          
BleKeyboard bleKeyboard("ur mom", "Rosa", 100);  // Replace Device Name / Manufacturer w/ your info
